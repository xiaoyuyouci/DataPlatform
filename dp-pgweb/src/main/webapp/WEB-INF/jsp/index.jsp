					...
					<ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                            	<shiro:hasPermission name="report:fcRealtimeGrid"><li><a class="hah" href="report/fcRealtimeGrid"> 工厂实时状态</a></li></shiro:hasPermission>
                                ...
                                <shiro:hasPermission name="report:dcQrCodeTimeConsuming"><li><a class="hah" href="report/dcQrCodeTimeConsuming"> DC条码使用查询</a></li></shiro:hasPermission>
